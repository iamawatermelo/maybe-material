...
>
> [Install latest version - v0.1.0](https://zed.dev/extensions/not-material-theme-v2)
...
- [Install Maybe Material from the Zed extension store.](https://zed.dev/extensions/not-material-theme)
